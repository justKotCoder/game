...
class Ball:
    ...
    def draw(self):
        ...
        if pos[2] >= self.canvas_width:
            # движемся влево
            self.x = -2
        if pos[3] >= self.canvas_height:#условие если наш мячик долетает до нижней границы
            self.hit_bottom = True
...
while True:
    if ball.hit_bottom == False:#Наша игра будет длиться пока это значение не изменится на True.
        ball.draw()        
        paddle.draw()
    else:
        break
